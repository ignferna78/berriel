...
public class UsuarioServiceImpl implements UserDetailsService, UsuarioService {
	...
	public Usuario findByPasswordResetToken(String token) throws Exception {
		...
		return usuario.filter(user -> user.getTokenExpirationTime() > System.currentTimeMillis()).orElseThrow(
				() -> new UsernameNotFoundException("Token de restablecimiento de contraseña inválido o caducado."));
	}
